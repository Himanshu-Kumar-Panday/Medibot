...
def main():
    st.markdown("<h1 style='text-align: left; color: white;'>MediBot ⚕</h1>", unsafe_allow_html=True)
    ...
    page_options = ["Chat with me", "Wellness Check", "Health Condition Tests", "Symptom Diagnosis Assistant", "Health Packages"]
    ...
    elif page_selection == "Health Condition Tests":
